        ...
        <div className="container">
            ...
            <div id="contentPar" className="contentParagraphs">
                ...
                <div className="contentParagraph">
                    <h1>ABOUT TETRISO</h1>
                    <p>
                        Tetriso is a copy of Tetris original game. Tetris is a 
                        addictive puzzle game that started it
                ...
                <div className="contentParagraph">
                    <h1>OBJECTIVE</h1>
                    <p>
                        The goal of Tetriso is to score as many points as
                        possible by clearing horizontal lines of Blocks. The
                        player must rotate, move, and drop the falling
                        Tetriminos inside the container with Blocks and have no
                        empty spaces. Lines are
                        cleared when they are fire cleared, the level increases
